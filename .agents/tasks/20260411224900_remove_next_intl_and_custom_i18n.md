...
### 추천 커밋 메시지
```
feat: remove next-intl and implement custom global i18n system

- Replace next-intl with custom Zustand-based i18n module
- Support fully qualified nested keys (e.g., t('SETTINGS.VALUES.OFF'))
- Implement server-side locale loading in RootLayout for SSR
- Refactor all UI components to use the new global i18n hook
- Remove unused next-intl configuration and dependencies
```
